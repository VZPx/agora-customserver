  ...
  static write(stream, obj) {
    if (obj === null) {
      ...
      this.writeBoolType(
        stream,
        obj,
        BinaryPacker2.Types.TYPE_TRUE,
        BinaryPacker2.Types.TYPE_FALSE,
      );
      ...
      this.writeVariableUnsigned(
        stream,
        obj.length,
        BinaryPacker2.Types.TYPE_STRING_8,
        BinaryPacker2.Types.TYPE_STRING_16,
        BinaryPacker2.Types.TYPE_STRING_32,
      );
      ...
      this.writeVariableUnsigned(
        stream,
        obj.length,
        BinaryPacker2.Types.TYPE_BINARY_8,
        BinaryPacker2.Types.TYPE_BINARY_16,
        BinaryPacker2.Types.TYPE_BINARY_32,
      );
      ...
      this.writeVariableUnsigned(
        stream,
        obj.length,
        BinaryPacker2.Types.TYPE_ARRAY_8,
        BinaryPacker2.Types.TYPE_ARRAY_16,
        BinaryPacker2.Types.TYPE_ARRAY_32,
      );
      obj.forEach((item) => BinaryPacker2.write(stream, item));
    } else if (obj instanceof Date) {
      stream.writeByte(BinaryPacker2.Types.TYPE_DATETIME);
      const seconds = Math.floor(
        (obj.getTime() - BinaryPacker2.EPOCH.getTime()) / 1000,
      );
      ...
      this.writeVariableUnsigned(
        stream,
        obj.size,
        BinaryPacker2.Types.TYPE_MAP_8,
        BinaryPacker2.Types.TYPE_MAP_16,
        BinaryPacker2.Types.TYPE_MAP_32,
      );
      obj.forEach((val, key) => {
